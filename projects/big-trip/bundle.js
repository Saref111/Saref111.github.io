...
class API {
  ...
  getDestinations() {
    return this._load({url: `destinations`})
      .then((response) => response.json())
      .then((destinations) => {
        return new _models_destinations_js__WEBPACK_IMPORTED_MODULE_1__["default"](destinations);
      });
  }
  ...
  getOffers() {
    return this._load({url: `offers`})
      .then((response) => response.json())
      .then((offers) => new _models_offers_js__WEBPACK_IMPORTED_MODULE_2__["default"](offers));
  }
  ...
  return (
    `<li class="trip-days__item  day">
      <div class="day__info">
        ...
        datetime="${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_1__["stringifyDate"])(date)}">
        ${moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`MMMM`)} ${moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`YY`)}</time>`}
      </div>
...
class Description extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/components/event-edit-form.js":
/*!*******************************************!*\
  !*** ./src/components/event-edit-form.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _description_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./description.js */ "./src/components/description.js");
...
const createEventFormElement = (mode, {type, place, price, offers, startTime, endTime, isFavorite, id}, totalOffers, allPlaces, externalData) => {
  ...
  return (
    `${mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT ? `<li class="trip-events__item">` : ``}<form class="trip-events__item  event  event--edit" action="#" method="post" id="${id}">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--destination">
        <label class="event__label  event__type-output" for="event-destination-1">
          ${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["getTitleByTypeInEditForm"])(type)}
        </label>
        <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" ${mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT ? `value="${place}"` : `value=""`} list="destination-list-1" required>
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyDate"])(startTime, `/`)} ${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyTime"])(startTime)}">
        —
        <label class="visually-hidden" for="event-end-time-1">
          To
        </label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyDate"])(endTime, `/`)} ${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyTime"])(endTime)}">
      </div>
      ...
      <button class="event__reset-btn" type="reset">${mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT ? externalData.deleteButtonText : `Cancel`}</button>
      ${mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT ? buttonFavoriteTemplate(isFavorite) : ``}
    </header>
    ${mode !== _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].FIRST ? createEventDetails(offers, totalOffers) : `</form>`}
    ${mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT ? `</li>` : ``}`
  );
};

class EventEditForm extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  rerender() {
    ...
    if (this._descriptionComponent && this._mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this.getElement().querySelector(`.event__details`), this._descriptionComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    }
  }
  ...
  _subscribeOnEvents() {
    ...
    typeListElement.addEventListener(`change`, (evt) => {
      if (evt.target.tagName === `INPUT`) {
        if (this._mode !== _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].EDIT) {
          this._data.type = evt.target.value;
          this._currentOffers = this._offersModel.getOffersByType(this._data.type).offers;
          this._mode = _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].CREATE;
        }
        this.rerender();
      }
    });
    ...
    element.querySelector(`#event-destination-1`).addEventListener(`input`, (evt) => {
      if (this._descriptionComponent) {
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._descriptionComponent);
      }
      ...
      if (this._destinationsModel.includesPlace(place)) {
        ...
        this._descriptionComponent = new _description_js__WEBPACK_IMPORTED_MODULE_4__["default"](description, pictures);

        if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].FIRST) {
          this._mode = _const_js__WEBPACK_IMPORTED_MODULE_2__["EditFormMode"].CREATE;
        }
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(offersContainerElement, this._descriptionComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      }
    });
  }
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStart = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(startTimeInputElement, {
      altInput: true,
      allowInput: true,
      enableTime: true,
      altFormat: `d/m/Y H:i`,
    ...
    this._flatpickrEnd = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(endTimeInputElement, {
      altInput: true,
      allowInput: true,
      enableTime: true,
      altFormat: `d/m/Y H:i`,
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title" id="${place}">${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["getTitleByType"])(type, place)}</h3>

        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyDate"])(startTime)}T${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyTime"])(startTime)}">${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyTime"])(startTime)}</time>
            &mdash;
            <time class="event__end-time" datetime="${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyDate"])(endTime)}T${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyTime"])(endTime)}">${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["stringifyTime"])(endTime)}</time>
          </p>
          <p class="event__duration">${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_0__["getDuration"])(endTime - startTime)}</p>
        </div>
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NewButtonComponent; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class NewButtonComponent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class Statistic extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  update() {
    ...
    const types = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getTypes"])(events);
    const moneyLabels = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getLabels"])(types);
    const transportTypes = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getTransportTypes"])(events);
    const transportLabels = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getLabels"])(transportTypes);
    const timeTypes = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getTimeTypes"])(events);
    ...
    const moneyChart = new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(moneyCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
      type: `horizontalBar`,
      data: {
        labels: moneyLabels,
        datasets: [{
          data: Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["countMoney"])(events, types),
    ...
    const transportChart = new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(transportCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
      type: `horizontalBar`,
      data: {
        labels: transportLabels,
        datasets: [{
          data: Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["countTransport"])(events, transportTypes),
          backgroundColor: `#ffffff`,
          hoverBackgroundColor: `#ffffff`,
          anchor: `start`
        }]
    ...
    const timeChart = new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(timeSpendCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
      type: `horizontalBar`,
      data: {
        labels: timeTypes,
        datasets: [{
          data: Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["countTime"])(events, timeTypes),
          backgroundColor: `#ffffff`,
          hoverBackgroundColor: `#ffffff`,
          anchor: `start`
        }]
      ...
      options: {
        plugins: {
          datalabels: {
            ...
            anchor: `end`,
            align: `start`,
            formatter: (val) => `${Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_3__["getDuration"])(val)}`
          }
        },
        title: {
          display: true,
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this.container, this, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  }
}
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: TYPES, CITIES, FilterType, EditFormMode, DefaultEvent, SHAKE_ANIMATION_TIMEOUT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditFormMode", function() { return EditFormMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DefaultEvent", function() { return DefaultEvent; });
...
class FilterController {
  constructor(container, model) {
    ...
    this._activeFilterType = _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].EVERYTHING;
  ...
  render() {
    ...
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["getEventsByFilter"])(allEvents, filterType).length,
...
/* harmony import */ var _components_event_edit_form_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event-edit-form.js */ "./src/components/event-edit-form.js");
...
class PointController {
  constructor(containerElement, onDataChange, onViewChange, destinationsModel, offersModel) {
    ...
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_5__["EditFormMode"].EDIT;
  ...
  render(event, dayComponents, isSorting, mode) {
    ...
    this._eventEditComponent = new _components_event_edit_form_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._mode, event, this._destinationsModel, this._offersModel);
    this._dayComponent = isSorting ? this._dayComponents[0] : this._dayComponents.find((day) => Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_4__["stringifyDate"])(day.date.startTime) === Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_4__["stringifyDate"])(event.startTime));


    switch (this._mode) {
      case _const_js__WEBPACK_IMPORTED_MODULE_5__["EditFormMode"].CREATE:
        this._onViewChange();
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventEditComponent);
        document.addEventListener(`keydown`, this._onEscHandler);
        break;


      case _const_js__WEBPACK_IMPORTED_MODULE_5__["EditFormMode"].EDIT:
        ...
        this._eventEditComponent.setAddFavoriteHandler(() => {
          const newEvent = _models_point_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(event);
        ...
        if (oldEventEditComponent && oldEventComponent) {
          ...
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._dayComponent.getElement().querySelector(`ul`), this._eventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
        }
        break;

      case _const_js__WEBPACK_IMPORTED_MODULE_5__["EditFormMode"].FIRST:
        this._onViewChange();
        this._eventEditComponent.setSubmitHandler((evt) => {
          evt.preventDefault();
  ...
  _eventToEditHandler() {
    ...
    if (this._mode !== _const_js__WEBPACK_IMPORTED_MODULE_5__["EditFormMode"].EDIT) {
      this._newButtonHandler();
    }
  ...
  _deleteEventHandler() {
    ...
    if (this._dayComponent.getElement().querySelector(`ul`).children.length === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._dayComponent);
    }
  }
  ...
  shake() {
    ...
    form.style.animation = `shake ${_const_js__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
...
/* harmony import */ var _components_no_events_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/no-events.js */ "./src/components/no-events.js");
/* harmony import */ var _components_trip_info_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/trip-info.js */ "./src/components/trip-info.js");
...
/* harmony import */ var _point_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./point.js */ "./src/controllers/point.js");
...
/* harmony import */ var _components_new_event_button_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/new-event-button.js */ "./src/components/new-event-button.js");
...
const getSortedEvents = (events, sortType) => {
  ...
  switch (sortType) {
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].PRICE:
      sortedEvents = currentEvents.sort((a, b) => b.price - a.price);
      break;
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].TIME:
...
const createDayComponents = (events, isSorting) => {
  if (isSorting) {
    return [new _components_day_js__WEBPACK_IMPORTED_MODULE_4__["default"](new Date(), true)];
  }

  const uniqueDates = [];
  events.forEach((event) => {
    if (uniqueDates.every((it) => Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_6__["stringifyDate"])(event.startTime) !== Object(_utils_util_js__WEBPACK_IMPORTED_MODULE_6__["stringifyDate"])(it.startTime))) {
      uniqueDates.push(event);
    }
  });

  return uniqueDates.map((event) => new _components_day_js__WEBPACK_IMPORTED_MODULE_4__["default"](event));
};

const sortDaysAndEventsByDefault = (days, container) => {
  days.sort((a, b) => a.date.startTime - b.date.startTime)
  .forEach((dayComponent) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, dayComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND));
};
...
class TripController {
  constructor(containerComponent, eventsModel, api) {
    ...
    this._newButtonComponent = new _components_new_event_button_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._noEventsComponent = new _components_no_events_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._tripInfoComponent = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  _onSortTypeChange(currentSortType) {
    ...
    this._controllers = this._renderTripEvents(
        ...
        currentSortType === _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].DEFAULT ? false : true,
  ...
  render() {
    ...
    this._newButtonComponent.setButtonHandler(() => {
      ...
      this._eventsModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_7__["FilterType"].EVERYTHING);
      this._events = this._eventsModel.getEvents();
      isFirstEvent = !this._events || this._events.length === 0;
      if (isFirstEvent) {
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._noEventsComponent);
      }
      const newPointController = new _point_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._container.getElement(), this._onDataChange, this._onViewChange, this._destinationsModel, this._offersModel);
      this._dayComponents.push(new _components_day_js__WEBPACK_IMPORTED_MODULE_4__["default"](_const_js__WEBPACK_IMPORTED_MODULE_7__["DefaultEvent"]));

      newPointController.setEnableNewButtonHandler(this._newButtonComponent.enabled);

      newPointController.render(_const_js__WEBPACK_IMPORTED_MODULE_7__["DefaultEvent"], this._dayComponents, null, isFirstEvent ? _const_js__WEBPACK_IMPORTED_MODULE_7__["EditFormMode"].FIRST : _const_js__WEBPACK_IMPORTED_MODULE_7__["EditFormMode"].CREATE);
      this._newButtonComponent.disabled();

      this._controllers.push(newPointController);
    });

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(headerMainElement, this._tripInfoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(headerMainElement, this._newButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(tripEventsElement, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(tripEventsElement, this._container, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);

    if (isFirstEvent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(containerElement, this._noEventsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      return;
    }
  ...
  _renderTripEvents(events, container, isSorting = false, onDataChange, onViewChange) {
    ...
    const controllers = eventsCopy.map((event) => {
      const pointController = new _point_js__WEBPACK_IMPORTED_MODULE_3__["default"](container, onDataChange, onViewChange, this._destinationsModel, this._offersModel);

      pointController.render(event, this._dayComponents, isSorting, _const_js__WEBPACK_IMPORTED_MODULE_7__["EditFormMode"].EDIT);
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_days_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/days-list.js */ "./src/components/days-list.js");
/* harmony import */ var _components_statistic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/statistic.js */ "./src/components/statistic.js");
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION_TOKEN);
...
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_6__["default"](tripControlsElement, eventsModel);
filterController.render();

const daysListComponent = new _components_days_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const tripController = new _controllers_trip_js__WEBPACK_IMPORTED_MODULE_5__["default"](daysListComponent, eventsModel, api);

filterController.joinSort(tripController.getSortComponent());

const statisticComponent = new _components_statistic_js__WEBPACK_IMPORTED_MODULE_3__["default"](eventsModel);
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(menuHeaderElement.nextSibling, menuComponent);
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getTransportTypes, getLabels, getTypes, countTransport, countMoney, getTimeTypes, countTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTransportTypes", function() { return getTransportTypes; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countTransport", function() { return countTransport; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countMoney", function() { return countMoney; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTimeTypes", function() { return getTimeTypes; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findEventObject", function() { return findEventObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTitleByType", function() { return getTitleByType; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTitleByTypeInEditForm", function() { return getTitleByTypeInEditForm; });
...
const stringifyDate = (date, sign) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY${sign ? sign : `-`}MMMM${sign ? sign : `-`}DD`);
};
